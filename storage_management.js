...
const not_disciplinas = ["NOTBIO7202","NOTBIO7203","NOTBIO7245","NOTEED5331","NOTMEN7004","NOTQMC5235","NOTBEG7220","NOTBIO7230","NOTECZ7201","NOTMIP7013","NOTPSI5137","NOTBEG7205","NOTBIO7210","NOTBQA7008","NOTECZ7031","NOTECZ7033","NOTBIO7004","NOTBEG7229","NOTBOT7201","NOTECZ7202","NOTMEN5601","NOTMIP7202","NOTBEG7211","NOTBOT7025","NOTECZ7032","NOTEED8007","NOTBIO7246","NOTBOT7202","NOTDGL7066","NOTDGL7067","NOTECZ7203","NOTLSB7904","NOTMEN7016","NOTBEG7212","NOTBOT7026","NOTCFS7100","NOTMOR7110","NOTBEG7228","NOTBIO7015","NOTBIO7218","NOTBIO7236","NOTFIL7007","NOTBIO7009","NOTBIO7016","NOTMEN7009","NOTMEN7341","NOTMEN7010"];

const disciplinas = bach_disciplinas.concat(lic_disciplinas, not_disciplinas);

const id_all = ["all_1","all_2","all_3","all_4","all_5","all_6","all_7","all_8","all_9", "all_lic_1", "all_lic_2", "all_lic_3", "all_lic_4", "all_lic_5", "all_lic_6", "all_lic_7", "all_lic_8", "all_lic_9", "all_lic_10", "not_all_1", "not_all_2", "not_all_3", "not_all_4", "not_all_5", "not_all_6", "not_all_7", "not_all_8", "not_all_9", "not_all_10"];
...
function checkboxStorage(){
    ...
    for (var i = 0; i < disciplinas.length; i++){
        if (document.getElementById(disciplinas[i]) === null){
          console.log(disciplinas[i]);
        }
        else if (document.getElementById(disciplinas[i]).disabled === false && document.getElementById(disciplinas[i]).checked === true){
